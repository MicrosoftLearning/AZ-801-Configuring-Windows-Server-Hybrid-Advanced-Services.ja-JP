...
1. **az801l07a-hv-vm** へのリモート デスクトップ セッション内で、Microsoft Edge を開始し、初期セットアップを完了し、[Windows Server Evaluations](https://www.microsoft.com/en-us/evalcenter/evaluate-windows-server-2022) にアクセスして、要求された情報を入力し、Windows Server 2022 **VHD** ファイルをダウンロードして、それを **F:\VHDs** フォルダーにコピーします。 
...
1. **[Appliance Configuration Manager]** ページの **[Provide Hyper-V host/cluster details]\(Hyper-V ホスト/クラスターの詳細を指定\)** で、 **[検出の開始]** を選択します。 
