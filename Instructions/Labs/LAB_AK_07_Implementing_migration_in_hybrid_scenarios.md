...
1. **[評価の作成]** ページの **[基本]** タブで、 **[評価の設定]** ラベルの横にある **[編集]** を選択します。   
1. **[評価の設定]** ページで、次の設定を指定し (他の設定は既定値のまま)、 **[保存]** を選択します。
...
1. **[意図の指定]** ページで、 **[続行]** を選択します。 **[レプリケート]** ページの [基本] タブにある **[お使いのマシンは仮想化されていますか?]** ドロップダウン リストで、 **[はい。Hyper-V を使用します]** を選んでから **[次へ]** を選択します。
...
1. **[移行およびモダン化 | マシンのレプリケート]** ページで、**az801l07a-vm1** 仮想マシンを表すエントリを選択します。
