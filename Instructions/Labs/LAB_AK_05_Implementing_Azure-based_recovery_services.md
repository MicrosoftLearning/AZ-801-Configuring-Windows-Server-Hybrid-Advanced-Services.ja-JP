...
1. **[ストレージ アカウントの作成]** ページの **[確認]** タブで、 **[作成]** を選択します。
...
1. **MARS エージェント**をダウンロードしてインストールするには、 **[MARS エージェント インストーラーのダウンロード](https://download.microsoft.com/download/0/6/7/067d515b-2c89-40fb-8dfc-4a94e9cfcbd9/MARSAgentInstaller.exe)** リンクを選択します。 
1. ダウンロード完了の通知に対して **[ファイルを開く]** を選択します。 これにより、**Azure Site Recovery サービス エージェントのセットアップ** ウィザードが開始されます。
1. **[インストールの設定]** ページで、 **[次へ]** を選択します。
1. **[プロキシの構成]** ページで、 **[次へ]** を選択します。
1. **[インストール]** ページで、 **[インストール]** を選択し、 **[閉じる]** を選択します。
