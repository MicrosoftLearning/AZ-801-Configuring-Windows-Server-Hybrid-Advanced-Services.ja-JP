...
1. Microsoft Edge を使用して [Windows Server Evaluations](https://www.microsoft.com/en-us/evalcenter/evaluate-windows-server-2022) から Windows Server 2022 **VHD** ファイルをダウンロードし、**F:\VHDs** フォルダーにコピーします。 
...
1. **[Appliance Configuration Manager]** ページの **[Provide Hyper-V host/cluster details]\(Hyper-V ホスト/クラスターの詳細を指定\)** で、検出を開始します。 
